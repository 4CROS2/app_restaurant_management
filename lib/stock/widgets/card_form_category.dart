...
class CardFormCategoryStock extends StatefulWidget {
  const CardFormCategoryStock({
    Key? key,
  }) : super(key: key);

  @override
  State<CardFormCategoryStock> createState() => _CardFormCategoryStockState();
}

class _CardFormCategoryStockState extends State<CardFormCategoryStock> {
